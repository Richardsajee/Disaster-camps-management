...
public class Viewnearestcamp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewnearestcamp);
        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        Intent i = new Intent(getApplicationContext(), Locationservice.class);
        startService(i);

        String url = sh.getString("url","")+"/nearestcamp";
...
//                                }
                                ...
                                listView.setAdapter(new customviewnearestcamp(getApplicationContext(),name,latitude,longitude, slot));
