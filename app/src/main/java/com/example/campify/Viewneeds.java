...
public class Viewneeds extends AppCompatActivity {
    String[] list, quantity,camp,volunter, phone,latitude,longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewneeds);
        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        listView = findViewById(R.id.list);
        Toast.makeText(this, ""+sh.getString("url", ""), Toast.LENGTH_SHORT).show();
        String url = sh.getString("url","")+"/viewneeds";
